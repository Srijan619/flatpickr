...
function FlatpickrInstance(
  ...
  function setSelectedDate(
    ...
    else if (isInstanceOfDate(inputDate) || typeof inputDate === "number")
    ...
    self.selectedDates = (self.config.allowInvalidPreload
      ? dates
      : dates.filter(
        (d) => isInstanceOfDate(d) && isEnabled(d, false)
      )) as Date[];
